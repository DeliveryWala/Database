...
public class ContentProvide extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.abhishek.database.provider";
    ...
    public String getType(Uri uri) {
        ...
        switch (code) {
            case All_NAME:
                return "vnd.android.cursor.dir/vnd.com.example.abhishek.database.provider.STUDENT";
            case SINGLE_NAME:
                return "vnd.android.cursor.item/vnd.com.example.abhishek.database.provider.STUDENT";
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
    }
